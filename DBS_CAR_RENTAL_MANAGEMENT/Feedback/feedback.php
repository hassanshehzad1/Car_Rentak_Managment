...
//  Customer ID aur Booking ID GET parameters se lo
$customer_id = isset($_GET['customer_id']) ? $_GET['customer_id'] : '';
$booking_id = isset($_GET['booking_id']) ? $_GET['booking_id'] : '';

//  Agar values na ho to error show karein
if (empty($customer_id) || empty($booking_id)) {
    die("❌ Error: Customer ID or Booking ID is missing.");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <!--  ADD FEEDBACK FORM -->
        <form action="../php/Feedback.php" method="post" class="mb-4">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="ratings" class="form-control" min="1" max="5" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Comments:</label>
                <textarea name="comments" class="form-control" rows="3" required></textarea>
            </div>
            <button type="submit" name="feedbackDetails" class="btn btn-success">Submit Feedback</button>
        </form>
    </div>
    <!-- Footer  -->
