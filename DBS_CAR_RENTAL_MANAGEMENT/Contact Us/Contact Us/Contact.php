...
<head>
  ...
  <title>Contact-Car rental Managment</title>
  <link rel="shortcut icon" href="/Home/logo.png" type="image/x-icon" />
  <!-- Bootstrap link  css-->
  <link
    ...
    <div class="main">
      ...
      <div class="signup">
        <form action="../../php/register.php" method="POST">
          ...
          <input type="hidden" name="customerDetails" value="1">
          ...
          <input type="number" name="age" placeholder="Age (Must be 18+)" min="18" required />
          ...
          <!--  Phone Number Fields -->
          <input type="tel" name="phone1" placeholder="Primary Contact Number" required />
          <input type="tel" name="phone2" placeholder="Secondary Contact Number (Optional)" />

          <!--  Submit Button -->
          <button type="submit">Register</button>
        </form>

        <a href="loginCus.php?car_id=<?php echo $car_id; ?>">Already have an account? Login</a>

      </div>
    </div>

    <div class="right_text d-flex flex-column justify-content-between">
      <h2 class="text-center">Let's Drive</h2>
      <div class="img_right_box">
        <img src="../../car rental images/contact/sports.png" alt="" />
      </div>
    </div>
  </section>
  <!-- Footer  -->
